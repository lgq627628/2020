...
import { Point, cache, canvasCache } from './Stroke';
...
export class Gesture {
    ...
    resample(inputPoints = this.points, count = this.sampleCount): Point[] {
        ...
        while (outputPoints.length < count) {
            outputPoints.push(prevPoint);
        }

        console.log(outputPoints.length);
        this.clearRect();
